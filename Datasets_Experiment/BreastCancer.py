...
spectralembedding = SpectralEmbedding(n_components=2, affinity='nearest_neighbors', n_neighbors=10, random_state=0)
...
PSC_index = PSC_index[398:569]  #pick up testing data


all_embedding = spectralembedding.fit_transform(X)
SC_index = kmeans.fit_predict(all_embedding)
SC_index = SC_index[398:569]  #pick up testing data
