...
u = torch.from_numpy(U1).type(torch.FloatTensor)
...
cluster3_index = cluster3_index[398:569]


all_matrix = SC(X)
cluster4_index = kmeans.fit_predict(all_matrix)
cluster4_index = cluster4_index[398:569]


acc3 = cluster_acc(y_test, cluster3_index)
acc4 = cluster_acc(y_test, cluster4_index)
sim = cluster_acc(cluster3_index, cluster4_index)


print(f"SC acc: {acc4:.3f}")
